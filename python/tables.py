...
NATURES = {
    "elemental":{
        ...
        "text":"[articulate t [name]] does not require air, food, drink, or sleep."
    },
    "undead":{
    ...
    "ooze":{
        "header":"Ooze",
        "text":"[articulate t [name]] does not require air or sleep."
    },
    "plant":{
        "header":"Plant",
        "text":"[articulate t [name]] does not require sleep."
    }
}
